...
contract CatalogCosignsImplementationTest is Test {
    ...
    function setUp() public {
        ...
        CatalogCosignsImplementation CSCLGV3Implementation = new CatalogCosignsImplementation();

        vm.startPrank(catalog);

        proxyContract = new CatalogCosigns(address(CSCLGV3Implementation));
